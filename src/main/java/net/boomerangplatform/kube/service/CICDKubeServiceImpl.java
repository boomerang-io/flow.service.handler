...
public class CICDKubeServiceImpl extends AbstractKubeServiceImpl {
	...
	@Override
	public V1Job createJob(String activityName, String workflowId, String activityId,String taskName, String taskId, List<String> arguments, Map<String, String> taskInputProperties) {
		...
		jobMetadata.annotations(createAnnotations(activityName, workflowId, activityId, taskId));
		jobMetadata.labels(createLabels(activityName, workflowId, activityId, taskId));
...
//			podSpec.addVolumesItem(volumeConfigMapTask);
		...
		podMetadata.annotations(createAnnotations(activityName, workflowId, activityId, taskId));
		podMetadata.labels(createLabels(activityName, workflowId, activityId, taskId));
