...
public interface AbstractKubeService {
  ...
  V1ConfigMap createWorkflowConfigMap(String workflowName, String workflowId,
      String workflowActivityId, Map<String, String> data);

  V1Job createJob(String workflowName, String workflowId, String workflowActivityId,
  ...
  V1ConfigMap createTaskConfigMap(String workflowName, String workflowId, String workflowActivityId,
      String taskName, String taskId, Map<String, String> inputProps);

  V1Status deleteConfigMap(String workflowId, String workflowActivityId, String taskId);

  Map<String, String> getTaskOutPutConfigMapData(String workflowId, String workflowActivityId,
  ...
  void patchTaskConfigMap(String workflowId, String workflowActivityId, String taskId,
