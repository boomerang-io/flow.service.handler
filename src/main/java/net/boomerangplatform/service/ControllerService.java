...
public interface ControllerService {
  ...
  Response setJobOutputProperty(String workflowId, String workflowActivityId, String taskId,
      String taskName, String key, String value);

  Response getLogForTask(String workflowId, String workflowActivityId, String taskId);

  StreamingResponseBody streamLogForTask(HttpServletResponse response, String workflowId,
