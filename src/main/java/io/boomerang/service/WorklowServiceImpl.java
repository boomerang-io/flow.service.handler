  ...
  public Response createWorkflow(Workflow workflow) {
    ...
    try {
      ...
      if (workflow.getWorkflowStorage().getEnable()) {
        String size = workflow.getWorkflowStorage().getSize() == null
            || workflow.getWorkflowStorage().getSize().isEmpty() ? storageSize
                : workflow.getWorkflowStorage().getSize();
        String className = workflow.getWorkflowStorage().getClassName();
        String accessMode = workflow.getWorkflowStorage().getAccessMode() == null
            || workflow.getWorkflowStorage().getAccessMode().isEmpty() ? storageAccessMode
                : workflow.getWorkflowStorage().getAccessMode();
